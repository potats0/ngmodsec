...
--- config
        ...
        location / {
            ...
            # 应用自定义规则
            rule 'rule 1060 http.uri contains "EnjoyRMIS_WS/WS/FileDown/cwsfiledown.asmx" and http.method = POST;';
...
--- request
POST /EnjoyRMIS_WS/WS/FileDown/cwsfiledown.asmx
