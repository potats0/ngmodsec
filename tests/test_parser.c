...
TEST_CASE(single_contains) {
    ...
    ASSERT_NOT_NULL(rule_mg->string_match_context_array, "Failed to allocate string_match_context_array");
    ...
    ASSERT(strcmp(rule_mg->string_match_context_array[0]->proto_var_name, "http.uri") == 0, "Wrong protocol variable name");
